...
<?php include('../layouts_moderator/sidebar.php'); ?>
<div class="col py-3">
    <table>
        <thead>
        ...
        while ($row = $query->fetch_assoc()) {
            ...
            <tr>
                ...
                <td>
                    <a href="moderator_edit_product.php?id=<?php echo $productID; ?>">Edytuj</a>
                </td>
            </tr>
						<?php
				}
...
<?php include('../layouts_moderator/moderator_footer.php') ?>