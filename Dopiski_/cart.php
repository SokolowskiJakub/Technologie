...
if (isset($_POST['add-to-cart'])) {
    ...
    if (isset($_SESSION['cart'])) {
        ...
        if (!in_array($_POST['product_id'], $products_array_ids)) {
            //pobiera wartość przekazaną przez formularz HTTP POST o nazwie "product_id" i przypisuje ją do zmiennej $product_id.
            ...
            //przypisywana jest wartość tablicy $product_array do elementu o indeksie $product_id w tablicy $_SESSION['cart'].
...
//usuniecie
    ...
    //Przypisuje wartości zmiennym $product_id i $product_quantity na podstawie danych przesłanych przez metodę POST.
    $product_id = $_POST['product_id'];
    $product_quantity = $_POST['product_quantity'];
