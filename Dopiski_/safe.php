...
//rozpoczyna pętlę foreach, iterującą przez elementy tablicy, $key przechowuje klucz, a $value przechowuje wartość każdego elementu.
<?php foreach($_SESSION['cart'] as $key => $value) { ?>

<tr>
    <td>
        <div class="product-cart-info">
            // wyświetla wartości pola product_image dla bieżącego elementu w tablicy.
